    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid gap-6">
            {applications.map((app: any) => (
              <div key={app.id} className="glass rounded-2xl p-6 hover:shadow-lg transition-shadow">
                <div className="flex justify-between items-start">
                  ...
                  <span className={`px-4 py-2 rounded-full text-sm font-semibold uppercase ${getStatusColor(app.status)}`}>
                    {app.status}
                  </span>
                </div>
              </div>
